...
class UsersManager extends Model
{
    ...
    public function ajoutCommentaire($user_id, $commentaire)
    {
        if (!empty($user_id) && !empty($commentaire)) {
            $req = "
            INSERT INTO commentaires (user_id, commentaire) VALUES (:user_id, :commentaire)";
            // connexion à bd
            $stmt = $this->getBdd()->prepare($req);
